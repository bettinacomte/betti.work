 $(document).ready(function(){
    $("#news").click(function goNews(){
        ...
        document.getElementById("newspage").style.transitionDuration = "700ms";
        document.getElementById("projectspage").style.transform = "translateX(-100vw)";
        document.getElementById("projectspage").style.transitionDuration = "700ms";
        document.getElementById("infopage").style.transform = "translateX(-100vw)";
        document.getElementById("infopage").style.transitionDuration = "700ms";

        document.getElementById("underbar").style.transform = "translateX(+160px)";
        document.getElementById("underbar").style.transitionDuration = "700ms";
    });
